...
for(const worker of['src/analytics-worker.js','src/data-worker.js'])if(paths.includes(worker)&&!paths.includes('viewer.html'))failures.push(`${worker} changed without rebuilding viewer.html`);
