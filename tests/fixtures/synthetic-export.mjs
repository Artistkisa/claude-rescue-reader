...
export const memories={global_memory:'Synthetic memory for CI only.',project_memories:{'00000000-0000-4000-8000-000000000301':'**SyntheticNebula**\n\nSynthetic widget blueprint memory.'}};
export const projects=[{uuid:'00000000-0000-4000-8000-000000000301',name:'Synthetic Project',description:'Synthetic project document',docs:[{uuid:'00000000-0000-4000-8000-000000000302',filename:'synthetic-blueprint.md',content:'# Synthetic blueprint\n\nWidget observatory specification.'}]}];
